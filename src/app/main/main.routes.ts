...
export const mainRoutes : Routes = [
    { path : '', component : MainComponent , children: [ //1.주소가 없을 때 main component이 나오고
    {path : '', redirectTo : 'products', pathMatch: 'full'}, //2. product로 redirect가 되고
    { path: 'products', component: ProductsComponent}, //3. products component가 한번에 나옴
